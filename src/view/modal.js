...
export const createModalTemplate = (card) => {
  const {filmInfo: {title, alternativeTitle, totalRating, director, writers, actors, poster, genres, description, runtime, release : {date, releaseCountry}}, userDetails: {watchlist, alreadyWatched, favorite}} = card;
